...
history = {'Adam': [(2015, 'Justin'), (2016, 'Amanda'), (2017, 'Angela')],
           'Adrienne': [(2016, 'Jeff'), (2017, 'Stefan')],
           'Amanda': [(2015, 'Adam'), (2016, 'Adrienne'), (2017, 'Jeff')],
           'Angela': [(2015, 'Joe'), (2016, 'David'), (2017, 'Francesca')],
           'David': [(2015, 'Stefan'), (2016, 'Francesca'), (2017, 'Renee')],
           'Francesca': [(2015, 'Angela'), (2016, 'Joe'), (2017, 'Adam')],
           'George': [(2015, 'Jeff'), (2016, 'Angela'), (2017, 'Adrienne')],
           'Jeff': [(2015, 'Nanna'), (2016, 'Justin'), (2017, 'Shaina')],
           'Joe': [(2015, 'Renee'), (2016, 'George'), (2017, 'Justin')],
           'Justin': [(2015, 'Francesca'), (2016, 'Adam'), (2017, 'George')],
           'Nanna': [(2015, 'David')],
           'Renee': [(2015, 'Amanda'), (2016, 'Stefan'), (2017, 'David')],
           'Shaina': [(2017, 'Amanda')],
           'Stefan': [(2015, 'George'), (2016, 'Renee'), (2017, 'Joe')],       
}
